...
/* USER CODE BEGIN PV */
volatile uint16_t tempDat = 0u;
// volatile uint16_t absRotorPos = 0u;
/* USER CODE END PV */
...
int main(void)
{
  ...
  */
  ...
  LL_DAC_ConvertData12RightAligned(DAC3,LL_DAC_CHANNEL_1,4000);
  LL_DAC_ConvertData12RightAligned(DAC3,LL_DAC_CHANNEL_2,4000);

  LL_DAC_TrigSWConversion(DAC3,LL_DAC_CHANNEL_1);

  while(READ_BIT(DAC3->SWTRIGR,(LL_DAC_CHANNEL_1 & DAC_SWTR_CHX_MASK)));

  LL_DAC_TrigSWConversion(DAC3,LL_DAC_CHANNEL_2);

  while(READ_BIT(DAC3->SWTRIGR,(LL_DAC_CHANNEL_2 & DAC_SWTR_CHX_MASK)));
  ...
  LL_DMA_ConfigAddresses(DMA1,LL_DMA_CHANNEL_2,(uint32_t)&USART1->RDR,(uint32_t)&frameReceiveForUSART,LL_DMA_DIRECTION_PERIPH_TO_MEMORY);
  LL_DMA_SetDataLength(DMA1,LL_DMA_CHANNEL_2,sizeof(FrameReceiveForUSART));
...
static void MX_ADC1_Init(void)
{
  ...
  PA2   ------> ADC1_IN3
  */
  GPIO_InitStruct.Pin = ADC1_S1_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(ADC1_S1_GPIO_Port, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = ADC1_BUS_Voltage_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(ADC1_BUS_Voltage_GPIO_Port, &GPIO_InitStruct);
...
static void MX_ADC2_Init(void)
{
  ...
  PA1   ------> ADC2_IN2
  */
  GPIO_InitStruct.Pin = ADC2_S2_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(ADC2_S2_GPIO_Port, &GPIO_InitStruct);
...
static void MX_COMP1_Init(void)
{
  ...
  PA11   ------> COMP1_OUT
  */
  GPIO_InitStruct.Pin = CP1_INP_BUSVOLTAGE_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(CP1_INP_BUSVOLTAGE_GPIO_Port, &GPIO_InitStruct);
...
static void MX_COMP2_Init(void)
{
  ...
  PA3   ------> COMP2_INP
  */
  GPIO_InitStruct.Pin = CP2_INP_S2_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(CP2_INP_S2_GPIO_Port, &GPIO_InitStruct);
...
static void MX_COMP3_Init(void)
{
  ...
  PC1   ------> COMP3_INP
  */
  GPIO_InitStruct.Pin = CP3_INP_S1_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(CP3_INP_S1_GPIO_Port, &GPIO_InitStruct);
...
static void MX_COMP4_Init(void)
{
  ...
  PB0   ------> COMP4_INP
  */
  GPIO_InitStruct.Pin = CP4_INP_S3_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(CP4_INP_S3_GPIO_Port, &GPIO_InitStruct);
...
static void MX_I2C1_Init(void)
{
  ...
  */
  ...
  /* I2C1_RX Init */
  LL_DMA_SetPeriphRequest(DMA2, LL_DMA_CHANNEL_2, LL_DMAMUX_REQ_I2C1_RX);
...
static void MX_TIM1_Init(void)
{
  ...
  TIM_InitStruct.Autoreload = 8499;
  ...
  TIM_BDTRInitStruct.BreakFilter = LL_TIM_BREAK_FILTER_FDIV2_N6;
...
static void MX_TIM8_Init(void)
{
  ...
  */
  ...
  LL_TIM_IC_SetFilter(TIM8, LL_TIM_CHANNEL_CH1, LL_TIM_IC_FILTER_FDIV1_N8);
...
static void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(SYS_LED_RED_GPIO_Port, SYS_LED_RED_Pin);

  /**/
  GPIO_InitStruct.Pin = SYS_MC_SS_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(SYS_MC_SS_GPIO_Port, &GPIO_InitStruct);
  ...
  /**/
  GPIO_InitStruct.Pin = SYS_LED_RED_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(SYS_LED_RED_GPIO_Port, &GPIO_InitStruct);
